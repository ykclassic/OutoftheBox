...
# Current stable Gemini model as of January 2026
...
"""
                ...
                st.caption("Verdict uses Gemini AI to reconstruct mindset — this is an informed reflection, not absolute truth.")
